...
const VerifyCard = () => {
  ...
  const handleSendEmail = async (e) => {
    ...
    try{
      ...
      const res = await axios.post(BASE_URL + "/user/send/otp", {otp}, {withCredentials: true});
    ...
    <div className="lg:w-2/6 md:w-3/6 w-5/6 h-4/6 p-6 border border-gray-300 rounded-lg shadow-md flex flex-col justify-center">
      ...
      <form>
        ...
        <div className="flex gap-4 flex-col">
          ...
          <button className="w-full py-3 bg-gradient-to-r from-blue-900 to-blue-500 rounded-full cursor-pointer">
            Verify Email
          </button>
        </div>
      </form>
